...
const RECIPES: readonly SplitRecipe[] = [
  {
    ...
    clearInstructionText: "Place crate atop shelf.",
    ambiguousInstructionText:
      "Unresolved prerequisite: Alex possibly skipped inspection. Investigate first.",
    speechX: 150,
    speechVx: 0,
    passX: 150,
    passVx: 0,
  ...
  },
  {
    ...
    clearInstructionText: "Set box beside door.",
    ambiguousInstructionText:
      "Mira may retain the box. Confirm ownership before removal.",
    speechX: 165,
    speechVx: -10,
    passX: 160,
    passVx: -20,
  ...
  },
  {
    ...
    clearInstructionText: "Put package by wall.",
    ambiguousInstructionText:
      "Route closure is possible. Establish passage condition, then decide on transport.",
    speechX: 145,
    speechVx: 10,
    passX: 140,
    passVx: 20,
