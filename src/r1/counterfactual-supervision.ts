...
const RECIPES: readonly SplitRecipe[] = [
  {
    ...
    clearInstructionText: "Place the crate on the shelf.",
    ambiguousInstructionText:
      "Alex's check status is uncertain. Determine it prior to moving the crate.",
    speechX: 150,
    speechVx: 0,
    passX: 150,
    passVx: 0,
  ...
  },
  {
    ...
    clearInstructionText: "Set the box beside the door.",
    ambiguousInstructionText:
      "Mira may still need this box. Verify her need before taking it.",
    speechX: 165,
    speechVx: -10,
    passX: 160,
    passVx: -20,
  ...
  },
  {
    ...
    clearInstructionText: "Put the package by the wall.",
    ambiguousInstructionText:
      "The route might be closed. Establish its status, then decide about carrying this package.",
    speechX: 145,
    speechVx: 10,
    passX: 140,
    passVx: 20,
